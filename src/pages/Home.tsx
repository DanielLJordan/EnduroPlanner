...
export default function Home() {
  ...
  // No org selected — prompt to create or join one
  if (orgLoaded && !organization) {
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
        <div className="flex flex-col items-center gap-6 text-center max-w-sm">
          <div className="w-14 h-14 bg-blue-600/20 border border-blue-700 rounded-2xl flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Create a team to manage races and invite your drivers. Each team's races are private and separate.</p>
          </div>
          <CreateOrganization
            appearance={{
              variables: {
